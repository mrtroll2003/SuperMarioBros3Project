...
#define ID_SPRITE_MARIO_TANOOKI_TAILFLICK_LEFT (ID_SPRITE_MARIO_TANOOKI_TAILFLICK + 10)
#define ID_SPRITE_MARIO_TANOOKI_TAILFLICK_RIGHT (ID_SPRITE_MARIO_TANOOKI_TAILFLICK + 20)
